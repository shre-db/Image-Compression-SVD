...
st.markdown("""
    **Image Data Storage and Deletion**
    ...
    At ImageSVD, we deeply value your privacy and want to ensure transparency regarding the handling
    ...
    **Image Data Collection**
    ...
    When you use our service, you may upload images for various purposes such as image compression, analysis,
    or processing. These images are temporarily stored on our servers solely for the purpose of performing the tasks
    you request.
    ...
    **Changes to this Privacy Notice**
    ...
    Thank you for choosing ImageSVD. We are dedicated to safeguarding your privacy and ensuring a
...
<p class="footer-signature"><i class="fa-solid fa-angle-down"></i>&nbspImageSVD</p>
'''
